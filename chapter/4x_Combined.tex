...
\begin{enumerate}
	...
	\item the textual representation is additional to the abstract representation, so that non containment references remain stable and non \code{EObject} referring, but \code{EObject} depending sentential tokens remain valid.
\end{enumerate}
